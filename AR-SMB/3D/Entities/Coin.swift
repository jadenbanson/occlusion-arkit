 ...
 */
        var coinBuff = ["cach.png", "chini.png", "kasunic.png", "oniel.png", "coin_normal.png"]
        ...
        surfaceMaterial.normal.contents = UIImage(named: "art.scnassets/coin/\(coinBuff[Int(arc4random_uniform(UInt32(coinBuff.count)))])")!
